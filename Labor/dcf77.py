...
class dcf77(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "DCF77 vevo")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("DCF77 vevo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "dcf77")
        ...
        self.rtlsdr_source_0.set_bandwidth(50, 0)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_moving_average_xx_0_0 = blocks.moving_average_ff(10000, 1/1000, 40000, 1)
        self.blocks_moving_average_xx_0 = blocks.moving_average_ff(1000, 1/100, 40000, 1)
        ...
        self.connect((self.blocks_abs_xx_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        ...
        self.connect((self.blocks_moving_average_xx_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_moving_average_xx_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(100, self.samp_rate, 50, 50, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=dcf77, options=None):
